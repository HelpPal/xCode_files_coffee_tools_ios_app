...
static const CGFloat kDefaultFrequencyForMiddleMark = 100;
static const CGFloat kSideOffset = 30.0;
static const CGSize  kMiddleMarkSize = {1, 10};
static const CGSize  kMajorMarkSize = {1, 10};
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.middleMark.textColor = [UIColor clearColor];
        ...
        double value = [[NSUserDefaults standardUserDefaults] doubleForKey:@"markKey"];
        self.majorMark.frequency = value;       // set default frequency
